...
func request_ECSService_ECSStatistic_0(ctx context.Context, marshaler runtime.Marshaler, client ECSServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ECSStatisticReq
	...
	msg, err := client.ECSStatistic(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ECSService_ECSStatistic_0(ctx context.Context, marshaler runtime.Marshaler, server ECSServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ECSStatisticReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ECSStatistic(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterECSServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ECSServiceServer) error {
	...
	mux.Handle("POST", pattern_ECSService_ECSStatistic_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/pbecs.ECSService/ECSStatistic")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ECSService_ECSStatistic_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ECSService_ECSStatistic_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterECSServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ECSServiceClient) error {
	...
	mux.Handle("POST", pattern_ECSService_ECSStatistic_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/pbecs.ECSService/ECSStatistic")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ECSService_ECSStatistic_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ECSService_ECSStatistic_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ecs", "statistic"}, ""))
)

var (
	forward_ECSService_ECSStatistic_0 = runtime.ForwardResponseMessage
)
