...
func TestEcser_ListDetail(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ali wrong cli", fields: aliFailed, args: args{&pboss.ListDetailReq{PageNumber: 1, PageSize: 1}}, wantErr: true},
		{name: "ali right cli", fields: ali, args: args{&pboss.ListDetailReq{PageNumber: 1, PageSize: 10}}, wantErr: false},
